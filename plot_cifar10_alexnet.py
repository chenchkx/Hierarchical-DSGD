...
csgd64_seed666_path = os.path.join(ROOT, 'CIFAR10_Feb24_06_46_26_jupyter-guest00_CIFAR10s64-64-csgd-fixed-16-AlexNet_M-1-0.1-0.0-0.1-0.0-0-6000-6000-666-False.csv')
csgd512_seed666_path = os.path.join(ROOT, 'CIFAR10_Feb24_06_47_25_jupyter-guest00_CIFAR10s64-512-csgd-fixed-16-AlexNet_M-1-0.8-0.0-0.1-0.0-0-6000-6000-666-False.csv')
dsgd64_seed666_path = os.path.join(ROOT, 'CIFAR10_Feb24_06_48_04_jupyter-guest00_CIFAR10s64-64-ring-fixed-16-AlexNet_M-1-0.1-0.0-0.1-0.0-0-6000-6000-666-False.csv')
dsgd512_seed666_path = os.path.join(ROOT, 'CIFAR10_Feb24_06_49_10_jupyter-guest00_CIFAR10s64-512-ring-fixed-16-AlexNet_M-1-0.8-0.0-0.1-0.0-0-6000-6000-666-False.csv')
...
plt.show()
plt.savefig(f'fig_cifar10_alexnet.pdf', format='pdf', bbox_inches='tight')
plt.close()
